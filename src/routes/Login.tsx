    ...
    return (
      <div className="container">
          <div className="div-one">
            <img id="cloud" src="https://bykerlogin.s3.ap-northeast-2.amazonaws.com/3525.svg" alt="alternative text" width="20%" height="100%" />
          </div>
          ...
          <div className="div-two">
              ...
              <img onClick={loginWithKakao} src="https://k.kakaocdn.net/14/dn/btqCn0WEmI3/nijroPfbpCa4at5EIsjyf0/o.jpg" width="222" alt="alt" />
            </a>
          </div>
          <div className="div-two">
